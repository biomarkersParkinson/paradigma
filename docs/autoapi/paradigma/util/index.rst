...
.. autoapisummary::
   ...
   paradigma.util.select_hours
   paradigma.util.select_days
...
.. py:function:: deprecated(reason: str = '')
   ...
   :param reason: Additional message to explain why it is deprecated and what to use
                  instead.
...
.. py:function:: transform_time_array(time_array: pandas.Series, input_unit_type: str, output_unit_type: str, start_time: float = 0.0) -> numpy.ndarray
   ...
   :param output_unit_type: The time unit type of the output time array. ParaDigMa expects
                            `TimeUnit.RELATIVE_S`.
...
.. py:function:: aggregate_parameter(parameter: numpy.ndarray, aggregate: str, evaluation_points: numpy.ndarray | None = None) -> numpy.ndarray | int
   ...
   :type aggregate: str
   :param evaluation_points: Should be specified if the mode is derived for a continuous parameter.
                             Defines the evaluation points for the kernel density estimation
                             function, from which the maximum is derived as the mode.
   :type evaluation_points: np.ndarray, optional
...
.. py:function:: select_hours(df: pandas.DataFrame, select_hours_start: str, select_hours_end: str) -> pandas.DataFrame

   Select hours of interest from the data to include in the aggregation step.

   :param df: Input data.
   :type df: pd.DataFrame
   :param select_hours_start: The start time of the selected hours in "HH:MM" format.
   :type select_hours_start: str
   :param select_hours_end: The end time of the selected hours in "HH:MM" format.
   :type select_hours_end: str

   :returns: The selected data.
   :rtype: pd.DataFrame


.. py:function:: select_days(df: pandas.DataFrame, min_hours_per_day: int) -> pandas.DataFrame

   Select days of interest from the data to include in the aggregation step.

   :param df: Input data with column 'time_dt' in which the date is stored.
   :type df: pd.DataFrame
   :param min_hours_per_day: The minimum number of hours per day required for including the day
                             in the aggregation step.
   :type min_hours_per_day: int
