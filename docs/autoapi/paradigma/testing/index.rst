...
.. autoapisummary::
   ...
   paradigma.testing.aggregate_pulse_rate_io
...
.. py:function:: extract_signal_quality_features_io(input_path: str | pathlib.Path, output_path: str | pathlib.Path, ppg_config: paradigma.config.PulseRateConfig, acc_config: paradigma.config.PulseRateConfig) -> pandas.DataFrame

   Extract signal quality features from the PPG signal and save them to a file.

   :param input_path: The path to the directory containing the preprocessed PPG and
                      accelerometer data.
...
.. py:function:: aggregate_pulse_rate_io(full_path_to_input: str | pathlib.Path, full_path_to_output: str | pathlib.Path, aggregates: list[str] = ['mode', '99p']) -> None

   Extract pulse rate from the PPG signal and save the aggregated pulse rate
   estimates to a file.

   :param input_path: The path to the directory containing the pulse rate estimates.
   :type input_path: str | Path
   :param output_path: The path to the directory where the aggregated pulse rate estimates
                       will be saved.
   :type output_path: str | Path
