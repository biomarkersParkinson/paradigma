...
.. py:function:: assign_sqa_label(ppg_prob: numpy.ndarray, config: paradigma.config.PulseRateConfig, acc_label: numpy.ndarray | None = None) -> numpy.ndarray
...
.. py:function:: extract_pr_from_segment(ppg: numpy.ndarray, tfd_length: int, fs: int, kern_type: str, kern_params: dict) -> numpy.ndarray
   ...
   :param ppg: The preprocessed PPG segment with 2 seconds of padding on both sides
               to reduce boundary effects.
   :type ppg: np.ndarray
   :param tfd_length: Length of each segment (in seconds) to calculate the time-frequency
                      distribution.
   :type tfd_length: int
   :param fs: The sampling frequency of the PPG signal.
   :type fs: int
   :param kern_type: Type of TFD kernel to use (e.g., 'wvd' for Wigner-Ville
                     distribution).
   :type kern_type: str
   :param kern_params: Parameters for the specified kernel. Not required for 'wvd', but
...
.. py:function:: extract_pr_with_tfd(ppg: numpy.ndarray, fs: int, kern_type: str, kern_params: dict) -> numpy.ndarray
   ...
   :returns: **pr_smooth_tfd** -- Estimated pr values (in beats per minute) for each 2-second segment
             of the PPG signal.
   :rtype: np.ndarray
...
.. py:class:: TimeFreqDistr
   ...
   .. py:method:: multiply_kernel_signal(tfd: numpy.ndarray, kern_type: str, kern_params: dict, n_len: int, n_half: int) -> numpy.ndarray
   ...
   .. py:method:: gen_doppler_lag_kern(kern_type: str, kern_params: dict, n_len: int, lag_index: int)
   ...
   .. py:method:: get_kern(g: numpy.ndarray, lag_index: int, kern_type: str, kern_params: dict, n_len: int) -> numpy.ndarray
   ...
   .. py:method:: get_window(win_length: int, win_type: str, win_param: float | None = None, dft_window: bool = False, n_pad: int = 0) -> numpy.ndarray
   ...
   .. py:method:: pad_window(w: numpy.ndarray, n_pad: int) -> numpy.ndarray
   ...
   .. py:method:: compute_tfd(n_len: int, n_half: int, tfd: numpy.ndarray)
